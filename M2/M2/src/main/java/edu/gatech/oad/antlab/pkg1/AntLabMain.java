 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Brandon Hill");
		  toPrint += p1.toString("bhill61");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Christa Peet");
		  toPrint += p2.toString("cpeet3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alex Lewis");
		  toPrint += p3.toString("alewis66");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Zach Guthrie");
                  toPrint += p4.toString("zguthrie3");
